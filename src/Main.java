    ...
    public static void main(String[] args) {
        ...
        while (choice != 5) {
            ...
            if (choice == 1) {
                ...
                System.out.print("Number of doors: "); int doors = input.nextInt();
                vehicles.add(new Car(brand, year, doors));
                System.out.println(">> Car added!");
            } else if (choice == 2) {
                System.out.print("Brand: "); String brand = input.nextLine();
                System.out.print("Year: "); int year = input.nextInt();
                System.out.print("Has sidecar? (true/false): "); boolean sidecar = input.nextBoolean();
                vehicles.add(new Motorcycle(brand, year, sidecar));
                System.out.println(">> Motorcycle added!");
            } else if (choice == 3) {
                System.out.print("Enter the number to remove: "); int number = input.nextInt();
